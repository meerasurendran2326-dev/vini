...
export default function AboutPage() {
  return (
    <div className="bg-ivory min-h-screen text-ink pb-32 selection:bg-sage/30 selection:text-forest">
      {/* Header Banner */}
      <div className="pt-16 pb-20 px-6 sm:px-10 lg:px-16 border-b border-line bg-pearl/60">
        <div className="max-w-5xl mx-auto text-center space-y-4">
          ...
          <p className="font-editorial italic text-xl sm:text-2xl text-muted max-w-2xl mx-auto">
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-10 lg:px-16 pt-16 space-y-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 relative aspect-[4/5] bg-pearl border border-line overflow-hidden shadow-md rounded-[2px]">
            <img
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <h2 className="font-sans text-3xl sm:text-4xl uppercase tracking-tight text-ink font-medium">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 space-y-6 lg:order-1 order-2">
            ...
            <div className="pt-2">
              <Link
                href="/shop"
                className="inline-flex items-center space-x-2 text-xs font-mono uppercase tracking-[0.14em] text-emerald hover:text-forest font-semibold"
              >
          ...
          <div className="lg:col-span-6 relative aspect-[4/5] bg-pearl border border-line overflow-hidden shadow-md rounded-[2px] lg:order-2 order-1">
            <img
