...
export const metadata: Metadata = {
  ...
  description:
    "A royal, classy light luxury digital showroom for hand-crafted 925 Solid Sterling Silver rings, pendants, heavy chains, and bespoke signets. Insured delivery across India.",
  keywords: [
    "925 silver",
    ...
    <html lang="en" className="bg-ivory text-ink">
      <body className="bg-ivory text-ink antialiased min-h-screen flex flex-col relative selection:bg-green/30 selection:text-forest">
        <CartProvider>
          ...
          {/* Page Content */}
          <main className="flex-1 pt-[108px] relative z-10">{children}</main>
